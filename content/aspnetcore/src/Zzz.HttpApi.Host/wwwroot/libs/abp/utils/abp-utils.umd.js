(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function __azzzer(thisArg, _arguments, P, generator) {
    ...
    ;
    function __azzz(v) {
        return this instanceof __azzz ? (this.v = v, this) : new __azzz(v);
    }
    function __asyncGenerator(thisArg, _arguments, generator) {
        ...
        function step(r) { r.value instanceof __azzz ? Promise.resolve(r.value.v).then(fulfill, reject) : settle(q[0][2], r); }
    ...
    function __asyncDelegator(o) {
        ...
        function verb(n, f) { i[n] = o[n] ? function (v) { return (p = !p) ? { value: __azzz(o[n](v)), done: n === "return" } : f ? f(v) : v; } : f; }
    }
