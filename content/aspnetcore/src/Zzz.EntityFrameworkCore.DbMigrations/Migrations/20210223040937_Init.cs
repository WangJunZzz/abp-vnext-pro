    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ZzzDataDictionary", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ZzzDataDictionaryDetail", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ZzzDataDictionaryDetail_ZzzDataDictionary_DataDictionaryId",
                        column: x => x.DataDictionaryId,
                        principalTable: "ZzzDataDictionary",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ZzzDataDictionaryDetail_DataDictionaryId",
                table: "ZzzDataDictionaryDetail",
