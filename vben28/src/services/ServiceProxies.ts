...
export class AuditLogsServiceProxy extends ServiceProxyBase {
   ...
   */
  page(
    body: PagingAuditLogListInput | undefined,
    cancelToken?: CancelToken | undefined,
  ): Promise<GetAuditLogPageListOutputPagedResultDto> {
...
export class EsLogServiceProxy extends ServiceProxyBase {
   ...
   */
  page(
    body: PagingElasticSearchLogInput | undefined,
    cancelToken?: CancelToken | undefined,
  ): Promise<PagingElasticSearchLogOutputCustomPagedResultDto> {
...
export class GetAuditLogPageListOutputPagedResultDto
  implements IGetAuditLogPageListOutputPagedResultDto
{
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['items'])) {
        this.items = [] as any;
        for (let item of _data['items']) this.items!.push(GetAuditLogPageListOutput.fromJS(item));
      }
...
export class PagingElasticSearchLogInput implements IPagingElasticSearchLogInput {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      (<any>this).skipCount = _data['skipCount'];
      this.filter = _data['filter'];
      this.startCreationTime = _data['startCreationTime']
        ? dayjs(_data['startCreationTime'].toString())
        : <any>undefined;
      this.endCreationTime = _data['endCreationTime']
        ? dayjs(_data['endCreationTime'].toString())
        : <any>undefined;
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data['skipCount'] = this.skipCount;
    data['filter'] = this.filter;
    data['startCreationTime'] = this.startCreationTime
      ? this.startCreationTime.toISOString()
      : <any>undefined;
    data['endCreationTime'] = this.endCreationTime
      ? this.endCreationTime.toISOString()
      : <any>undefined;
    return data;
  }
}
...
export class PagingElasticSearchLogOutputCustomPagedResultDto
  implements IPagingElasticSearchLogOutputCustomPagedResultDto
{
