...
<script lang="ts">
import { defineComponent, PropType, ref, watchEffect, computed, unref, reactive,watch } from 'vue';
...
export default defineComponent({
  ...
  props: {
    ...
    rowKey: propTypes.string.def('rowKey'),
  ...
  setup(props, { emit }) {
    ...
    function clickRow(menuNode, index) {
