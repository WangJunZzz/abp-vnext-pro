...
export function useFormValues({
  ...
  function handleFormValues(values: Recordable) {
    ...
    return handleRangeTimeValue(res), handleRangeNumberValue(res);
  }
  ...
  function handleRangeNumberValue(values: Recordable) {
    const fieldMapToNumber = unref(getProps).fieldMapToNumber;
