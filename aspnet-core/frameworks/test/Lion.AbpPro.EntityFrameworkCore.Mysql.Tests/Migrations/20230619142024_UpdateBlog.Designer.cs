...
namespace Lion.AbpPro.EntityFrameworkCore.Tests.Migrations
{
    ...
    [Migration("20230619142024_UpdateBlog")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lion.AbpPro.EntityFrameworkCore.Tests.Blogs.Comment", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Lion.AbpPro.EntityFrameworkCore.Tests.Blogs.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Lion.AbpPro.EntityFrameworkCore.Tests.Entities.Blogs.Blog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Lion.AbpPro.EntityFrameworkCore.Tests.Blogs.Comment", b =>
                {
                    b.HasOne("Lion.AbpPro.EntityFrameworkCore.Tests.Blogs.Post", null)
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Lion.AbpPro.EntityFrameworkCore.Tests.Blogs.Post", b =>
                {
                    b.HasOne("Lion.AbpPro.EntityFrameworkCore.Tests.Entities.Blogs.Blog", null)
                        .WithMany("Posts")
