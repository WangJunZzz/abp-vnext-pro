...
public static class BasicManagementErrorCodes
{
    ...
    public const string NewPasswordExpire = BasicManagementConsts.NameSpace + ":200001";
    public const string OldPasswordExpire = BasicManagementConsts.NameSpace + ":200002";
}