...
namespace Lion.AbpPro
{
    ...
    public class AbpProIdentityServerModule : AbpModule
    {
        ...
        {
            Configure<AbpVirtualFileSystemOptions>(options => { options.FileSets.AddEmbedded<AbpProIdentityServerModule>(); });
